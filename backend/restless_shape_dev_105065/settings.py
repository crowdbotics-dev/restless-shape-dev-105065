"""
Django settings for restless_shape_dev_105065 project.
...
ROOT_URLCONF = 'restless_shape_dev_105065.urls'
...
WSGI_APPLICATION = 'restless_shape_dev_105065.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_shape_dev_105065 API",
    "DESCRIPTION": "API documentation for restless_shape_dev_105065 App",
    "VERSION": "v1",
}
