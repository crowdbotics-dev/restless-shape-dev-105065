...
## Project Structure
    ...
    ├── restless_shape_dev_105065  # Django project configurations
...
1. Clone this repo and `cd restless_shape_dev_105065`
...
2. Clone this repo and `cd restless_shape_dev_105065`
